...
public class MeicanProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        page.putField("区域名称：", page.getHtml().xpath("//h1[@id=\"page_title\"]/text()"));
        page.putField("店铺名称：", page.getHtml().xpath("//ul[@class=\"simple_restaurant_list not_index\"]/li/h1[@class=\"name\"]/a[@class=\"restaurant_link\"]/text()"));
        page.putField("prices", page.getHtml().xpath("//div[@class=\"dishes menu_dishes slides_container\"]/li/span[@class=\"price_outer\"]/span[@class=\"price\"]/text()"));
    }
    ...
    public static void main(String[] args) {
        Spider.create(new MeicanProcessor()).addPipeline(new DataBasePipeline()).run();
    }
}
