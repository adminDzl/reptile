...
import com.reptile.common.framework.util.net.socket.SocketAppHandler;
 ...
 * @version
 */
public class CustomServicesHandler extends IoHandlerAdapter {
	public static Logger logger = Logger.getLogger(CustomServicesHandler.class);
	...
	public void messageReceived(IoSession session, Object message) throws Exception {
		...
		SocketResponseDto socketResponseDto = SocketAppHandler.getInstance().handleRequest(socketRequestDto);
