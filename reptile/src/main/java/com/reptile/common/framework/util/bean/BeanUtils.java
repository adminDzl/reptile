package com.reptile.common.framework.util.bean;
 ...
 * 类描述：   
 * 创建人：		net work
 * 创建时间：		2014-11-25 下午4:55:57   
 * 修改人：		liuxing
 * 修改时间：		2014-11-25 下午4:55:57   
 * 修改备注：   
 * @version
 */
public class BeanUtils extends org.springframework.beans.BeanUtils {
	...
	public String openDeclaration = "open declaration" ;
	
	/***
	 * 非空对象指定属性值deep copy
	 * @param source	数据源
	 * @param target	copy给目标对象
	 * @param ignoreProperties		不需要deep copy的属性数组
	...
	/****
	 * 非空对象属性值指定数据类型deep copy
	 * @param source	数据源
	 * @param target	copy给目标数据
	 * @param editable	指定目标类的数据类型
	 * @throws BeansException
	 */
