...
public class TestPageProcesser implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        page.putField("author", page.getUrl().regex("https://mapserver\\.ghips\\.cn/(\\w+)/.*").toString());
        page.putField("name", page.getHtml().xpath("//div[@class='text_success public']/span/text()").toString());
        ...
        page.addTargetRequests(page.getHtml().links().regex("(https://mapserver\\.ghips\\.cn/\\w+/\\w+)").all());
    }
    ...
    public static void main(String[] args) {
    	...
    	//Spider.create(new TestPageProcesser()) .addUrl("https://github.com/code4craft")
    	Spider.create(new TestPageProcesser()) .addUrl("http://mapserver.ghips.cn:8289/ultbak")
